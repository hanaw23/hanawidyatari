...
export default function PostmanIcon(props) {
  ...
  return (
    <DetailHover
      icon={
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={props.className} width={props.width} height={props.height} fill={props.fill} onMouseEnter={handleHover} onMouseLeave={handleLeaveHover}>
