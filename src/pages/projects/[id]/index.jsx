...
export default function ProjectDetailPage() {
  ...
  return (
    <div className="flex flex-col w-full h-full py-2">
      {/* Title */}
      <div className="mx-6 lg:mx-20 mt-2 opacity-0 animate-fadeUp [animation-delay:400ms]">
        <h1 className="mt-10 text-[45px] lg:text-[65px] font-bold">{customColorFirstWord(data?.name, "#a934dc")}</h1>
      </div>

      <div className="m-4 ">
        <div className="opacity-0 animate-fadeUp [animation-delay:500ms]">
        ...
        {/* Content */}
        <div className="mb-6 -mt-6 lg:-mt-4 opacity-0 animate-fadeUp [animation-delay:600ms]">
