      ...
      <ParallaxBanner
        layers={[
          { image: "assets/images/background.png", speed: -30 },
          {
            speed: -40,
            children: (
              <div className="absolute inset-0 flex items-center justify-center -mt-[100%] md:-mt-[80%] lg:-mt-[30%]">
                <h1 className="text-center text-8xl text-gray-200 font-thin mx-8">Explore My Works</h1>
              </div>
            ),
          },
